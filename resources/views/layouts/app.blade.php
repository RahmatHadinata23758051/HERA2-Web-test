        ...
        <div class="hidden md:block h-12 bg-white border-b border-surface-container-highest">
            <div class="px-4 md:px-8 lg:px-12 h-full flex items-center gap-1 max-w-[1800px] mx-auto">
                ...
                <a href="{{ route('dashboard') }}" 
                   class="flex items-center gap-1.5 h-full px-3 text-sm font-medium transition-colors border-b-2 {{ request()->routeIs('dashboard') ? 'text-primary border-primary font-bold' : 'text-on-surface-variant border-transparent hover:text-primary hover:border-primary/40' }}">
                ...
                <a href="{{ route('monitoring') }}" 
                   class="flex items-center gap-1.5 h-full px-3 text-sm font-medium transition-colors border-b-2 {{ request()->routeIs('monitoring*') ? 'text-primary border-primary font-bold' : 'text-on-surface-variant border-transparent hover:text-primary hover:border-primary/40' }}">
                ...
                <div x-data="{ openAnalysis: false }" @mouseenter="openAnalysis = true" @mouseleave="openAnalysis = false" class="relative h-full flex items-center">
                    <button @click="openAnalysis = !openAnalysis" 
                            class="flex items-center gap-1.5 h-full px-3 text-sm font-medium outline-none transition-colors border-b-2 {{ request()->routeIs('analisis.*') ? 'text-primary border-primary font-bold' : 'text-on-surface-variant border-transparent hover:text-primary hover:border-primary/40' }}">
                ...
                <a href="{{ route('admin.users.index') }}" 
                   class="flex items-center gap-1.5 h-full px-3 text-sm font-medium transition-colors border-b-2 {{ request()->routeIs('admin.users*') ? 'text-primary border-primary font-bold' : 'text-on-surface-variant border-transparent hover:text-primary hover:border-primary/40' }}">
                ...
                <div x-data="{ openLaporan: false }" @mouseenter="openLaporan = true" @mouseleave="openLaporan = false" class="relative h-full flex items-center">
                    <button @click="openLaporan = !openLaporan" 
                            class="flex items-center gap-1.5 h-full px-3 text-sm font-medium outline-none transition-colors border-b-2 {{ request()->routeIs('laporan.*') ? 'text-primary border-primary font-bold' : 'text-on-surface-variant border-transparent hover:text-primary hover:border-primary/40' }}">
                ...
                <a href="{{ route('settings.index') }}" 
                   class="flex items-center gap-1.5 h-full px-3 text-sm font-medium transition-colors border-b-2 {{ request()->routeIs('settings*') ? 'text-primary border-primary font-bold' : 'text-on-surface-variant border-transparent hover:text-primary hover:border-primary/40' }}">
