...
<body onclick="window.location.href = '{{ url('/dashboard') }}';" title="Klik di mana saja untuk Kembali ke Beranda">
    ...
    <div id="jail">
      <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <text x="0" y="0" text-anchor="left" style="font-size:90pt; fill:#4b5563;">
